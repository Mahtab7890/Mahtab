...
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Mahtab123.flf ]; then
	echo -e "\e[1;34m[*] \033[32mMahtab123.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/Mahtab7890/MAHTAB123/master/Mahtab123.flf &> /dev/null;
sleep 3
cat Remo773.flf >> $PREFIX/share/figlet/Mahtab123.flf
sleep 3
rm Mahtab123.fif
fi
THEADER () 
...
clear
TNAME="$PROC";
echo -e "\033[32m$(figlet -f Mahtab123.flf "$TNAME")\033[0m";
echo "";
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo -e '\033[1;43;30m### MAHTAB ### \033[0m';
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
...
if [ "$PROC32" = "y" ]; then
	...
	wget https://raw.githubusercontent.com/Mahtab7890/MAHTAB123/master/t-head.txt &> /dev/null ;
	...
	if [ -e $PWD/.mahtab123.zsh-theme ]; then
	sed -e "s/\Mahtab123/$PROC/g" .mahtab123.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
else
wget https://raw.githubusercontent.com/Mahtab7890/T-Header/master/.mahtab123.zsh-theme &> /dev/null
sed -e "s/\Mahtab123/$PROC/g" .mahtab123.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
fi
source ~/.zshrc
else
...
clear;
echo -e "\033[31m$(figlet -f Mahtab123 "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Mahtab123 : (\e[33m10.10.2019\e[32m)
