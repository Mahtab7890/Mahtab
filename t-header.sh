...
termux-wake-lock;
if [ -e $PREFIX/share/figlet/Mahtab.flf ]; then
	echo -e "\e[1;34m[*] \033[32mMahtab.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/Mahtab7890/MAHTAB/master/Mahtab.flf &> /dev/null;
sleep 3
cat Mahtab.flf >> $PREFIX/share/figlet/Mahtab.flf
sleep 3
rm Mahtab.fif
fi
THEADER () 
...
clear
TNAME="$PROC";
echo -e "\033[32m$(figlet -f Mahtab.flf "$TNAME")\033[0m";
echo "";
...
if [ "$PROC32" = "y" ]; then
	...
	wget https://raw.githubusercontent.com/Mahtab7890/MAHTAB/master/t-head.txt &> /dev/null ;
	...
	if [ -e $PWD/.mahtab.zsh-theme ]; then
	sed -e "s/\Mahtab/$PROC/g" .mahtab.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
else
wget https://raw.githubusercontent.com/Mahtab7890/T-Header/master/.mahtab.zsh-theme &> /dev/null
sed -e "s/\Mahtab/$PROC/g" .mahtab.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
fi
source ~/.zshrc
else
...
clear;
echo -e "\033[31m$(figlet -f Mahtab "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
Mahtab : (\e[33m10.10.2019\e[32m)
