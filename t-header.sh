...
sleep 3
cat Mahtab7890.flf >> $PREFIX/share/figlet/Mahtab.flf
sleep 3
rm Mahtab.fif
fi
THEADER () 
...
echo -e '\033[1;43;30m### Mahtab Ahmed ### \033[0m';
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
...
if [ "$PROC32" = "y" ]; then
	...
	sed -e "s/\Mahtab/$PROC/g" .remo773.zsh-theme > $HOME/.oh-my-zsh/themes/xiong-chiamiov-plus.zsh-theme
else
